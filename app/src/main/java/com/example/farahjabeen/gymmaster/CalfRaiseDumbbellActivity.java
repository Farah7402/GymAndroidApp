...
public class CalfRaiseDumbbellActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {


    public static final String API_KEY = "AIzaSyDnM32PTFmNpUMe1Izj81ITA6hjsZ2CZ14 \t";
    public static final String VIDEO_ID = "wxwY7GXxL4k";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calf_raise_dumbbell);

        mToolbar = (Toolbar) findViewById(R.id.atoolbar);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Calf Raise Dumbbell ");
