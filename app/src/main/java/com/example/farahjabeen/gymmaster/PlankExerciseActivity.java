...
public class PlankExerciseActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {


    public static final String API_KEY = "AIzaSyDnM32PTFmNpUMe1Izj81ITA6hjsZ2CZ14 \t";
    public static final String VIDEO_ID = "tgbrMdfuGJA";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Plank Exercise");
